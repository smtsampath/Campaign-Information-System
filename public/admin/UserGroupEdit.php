...
if(isset($_POST['submit']) && $_POST['submit']=="Update")
{
		...
		foreach ($fvars as $key=>$value) {
			if(!isset($key) || ($value == ''))
				 $errmsg= "Please enter a GroupID<br>";	
	 ...
	 if($errmsg=='')
	 {
		...
		if($userobj->edit_userGroup($Userid, $Groupid))
		{
			$msg.= 'User Group Details successfully updated.<br>';
		}
		else {
...
<?php require_once("../layouts/user_header.php"); ?>
        ...
        <table width="190" border="0">
          ...
          <tr>
            <td class="td3"><font color="#FF6666">User Group</font></td>
          </tr>
          <tr>
...
<table width="100%" border="0">
  ...
  <td  colspan="2" valign="bottom">
    <form action="UserGroupEdit.php?id=<?php echo $Userid; ?>" method="post" name="UserGroupEdit">
		  <table align="center">
           <tr>
...
?>
          ...
          <td height="20">&nbsp;</td>
           ...
           <tr>
		      <td>Username:</td>
		      <td>
		        <input type="text" id="Username" size="30" name="Username" disabled="disabled" class="input" value="<?php echo $Username; ?>" />
		      </td>
		    </tr>
		    <tr>
		      <td>Password:</td>
		      <td>
		        <input type="text" id="Groupid" size="30" name="Groupid" class="input" value="<?php echo $Groupid; ?>" />
		      </td>
		    </tr>
            <tr>
