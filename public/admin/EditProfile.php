...
$Userid = $_SESSION["uid"];
		...
		$query = "SELECT Firstname, Lastname, Address, Email, Mobile
					FROM user 
					WHERE Userid = $Userid ";
...
if(isset($_POST['submit']) && $_POST['submit']=="Update")
{
	 ...
	 if($errmsg=='')
	 {
		...
		if(!preg_match("/\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*/",$_POST['Email']))
		{
			...
			if($userobj->update_userPersonal($Userid, $Firstname, $Lastname, $Address, $Email, $Mobile))
			{
...
<?php require_once("../layouts/user_header.php"); ?>
        ...
        <table width="190" border="0">
          ...
          <tr>
            <td class="td3"><a href="Profile.php">Change Password</a></td>
          </tr>
          <tr>
            <td class="td3"><font color="#FF6666">Edit Profile</font></td>
          </tr>
           <tr>
...
<table width="100%" border="0">
  ...
  <tr>
   ...
   <tr>
    <td colspan="2" align="center"><h1>ENTER YOUR PERSONAL DETAILS HERE</h1></td>
  <tr>
    <td colspan="2" height="10">&nbsp;</td>
  </tr>
  <tr>
